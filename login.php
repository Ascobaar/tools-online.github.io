...
/**
 * SDM | SDM21 File Manager V2.4.3
 * SDM21 Programmers | sdm21sec@gmail.com
...
//Application Title
define('APP_TITLE', 'SDM21 File Manager');
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="SDM SDM21 File Manager">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://tinyfilemanager.github.io/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">SDM21 Programmers</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> SDM21 File Manager <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Prasath Mani</p>
                        <p>Mail Us: <a href="mailto:sdm21sec@gmail.com">sdm21sec[at]gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">SDM21 File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">SDM21 File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'SDM21 File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with SDM21 File Manager">
    <meta name="author" content="SDM21 Programmers">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'SDM21 File Manager';      $tr['en']['AppTitle']           = 'File Manager';
